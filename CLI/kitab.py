...
try:
    ...
    print(f"Could not load icon: {e}")  # For debugging
...
language_dropdown = ttk.Combobox(frame, textvariable=language_var, values=["English", "Azərbaycan"], state="readonly", width=10)
